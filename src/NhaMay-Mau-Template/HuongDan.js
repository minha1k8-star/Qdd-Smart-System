...
var HUONG_DAN_ROWS = [
  ...
  ['A3b', 'MÃ CÔNG TƠ KHÔNG KÈM CHỮ SỐ NĂM. File "17076001.CSV" = ngày 17, tháng 07, năm 2026 (số 6), công tơ 001 — điền "csv001", KHÔNG điền "csv6001". Điền kèm chữ số năm thì sang năm sau (file thành 17077001.CSV) hệ thống không nhận ra file nào.'],
  ['A3d', 'MÃ CÔNG TƠ GHI DẠNG "csv001" (có chữ csv phía trước). Nếu ghi "001" thì Google Sheets tự hiểu là SỐ 1 và cắt mất hai số 0 đầu — chữ "csv" giữ cho ô luôn là văn bản, đồng thời nhắc người đọc đó là mã nằm trong TÊN FILE CSV. "Thiết lập sheet" tự chuẩn hoá về dạng này.'],
